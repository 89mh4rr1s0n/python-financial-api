  ...
  # if __name__ == "__main__":
    ...
    if '{' in df.columns:
        ...
        print(datetime.now().strftime(
            "%d/%m/%Y %H:%M:%S" + ' finished inserting ' + title))


# print(datetime.now().strftime("%d/%m/%Y %H:%M:%S" + ' started inserting '))
insert_data(
    "https://financialmodelingprep.com/api/v4/income-statement-bulk?year=2023&period=quarter&apikey=e812649ac124bbb4d773e2ff24a28f0d",
    "test_upsert_dfe",
    "first test"
)
