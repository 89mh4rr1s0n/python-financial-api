...
def tone_count_with_negation_check(dict, article):
    ...
    item = {
        ...
        "% positive": round((pos_count / word_count) * 100, 3),
        "negative words": neg_count,
        "% negative": round((neg_count / word_count) * 100, 3),
        "words net": pos_count - neg_count,
...
tickers = ["CELH",	"LPLA",	"MP",	"H",	"H",	"GTLS",	"EXLS",	"WSC",	"LNTH",	"SWAV",	"RPD",	"NEWR",	"ATI",	"WMS",	"DY",	"MLM",	"SUM",	"STAA",	"ASML",	"FSLR",	"ADNT",	"IAC",	"NCLH",	"WYNN",	"SGFY",	"JJSF",	"LYB",	"DOW",	"CE",	"WY",	"WFG",	"BG",	"FCX",	"TWLO",	"TRP",	"MT",	"SE",	"RIO",	"BHP",	"SPG",	"SLF",	"CRH",	"BMO",	"TEF",	"TROW",	"PH",	"TRP",	"EIX",	"ZBH",	"BAX",	"MDT",	"SAP",	"NSC",	"TGT",	"SYK",	"LEN",	"SMG",	"LPX",	"DHI",
]
